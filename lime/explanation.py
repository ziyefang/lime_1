...
class Explanation(object):
    ...
    def show_in_notebook(self, labels=None, predict_proba=True, text=None):
    ...
    def as_html(self, labels=None, predict_proba=True, text=None):
        ...
        Args:
            ...
            text: raw text data. If present, include the text in the HTML page,
                  ...
                  color. If more than one label is present, highlights the words
                  according to the explanation of labels[0].
        ...
        if text is not None:
            ...
            for word, val in self.as_list(labels[0]):
